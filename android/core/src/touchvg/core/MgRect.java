...
public class MgRect extends MgBaseRect {
  ...
  public String getTypeName() {
    return touchvgJNI.MgRect_getTypeName(swigCPtr, this);
  }
  ...
  public float hitTest(Point2d pt, float tol, MgHitResult result) {
    return touchvgJNI.MgRect_hitTest(swigCPtr, this, Point2d.getCPtr(pt), pt, tol, MgHitResult.getCPtr(result), result);
  }
