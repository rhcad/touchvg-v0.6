...
public class MyPaintView extends Object {
    ...
    public void setContextButtonImages(int[] names) {
        this.mView.setContextButtonImages(names);
    }
    ...
    public String switchShapeType() {
        String[] names = { "splines", "line", "rect", "square", "ellipse", "circle",
            "triangle", "diamond", "polygon", "quadrangle", "lines",
            "grid", "arc3p", "arc-cse", "arc-tan",
            null };
        ...
        setCommandName(names[i]);
        return getCommandName();
    }

    public String setShapeType(String shapeName)
    {
    	setCommandName(shapeName.isEmpty() ? "@draw" : shapeName);
    	return getCommandName();
    }
    ...
    public void setBitmapIDs(int vgdot1, int vgdot2, int placeholder) {
        mView.setBitmapIDs(vgdot1, vgdot2, placeholder);
    }
