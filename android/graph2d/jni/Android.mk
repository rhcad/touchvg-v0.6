...
LOCAL_C_INCLUDES := $(VCORE_PATH)/include/geom \
                    ...
                    $(VCORE_PATH)/include/command \
                    $(VCORE_PATH)/include

LOCAL_SRC_FILES  := GiCoreView.cpp \
                    GiCanvasBase.cpp \
                    graph2d_java_wrap.cpp \
                    ...
                    $(SRC_PATH)/shape/mgshapes.cpp \
                    $(SRC_PATH)/shape/mgsplines.cpp \
                    $(SRC_PATH)/shape/mgshapedoc.cpp \
                    $(SRC_PATH)/shape/mgcomposite.cpp \
                    $(SRC_PATH)/command/mgcmddraw.cpp \
                    $(SRC_PATH)/command/mgcmds.cpp \
                    $(SRC_PATH)/command/mgcmdselect.cpp \
                    $(SRC_PATH)/command/mgcmderase.cpp \
                    $(SRC_PATH)/command/mgcmdmgr.cpp \
                    $(SRC_PATH)/command/mgactions.cpp \
                    $(SRC_PATH)/command/mgdrawline.cpp \
                    $(SRC_PATH)/command/mgdrawlines.cpp \
                    $(SRC_PATH)/command/mgdrawrect.cpp \
                    $(SRC_PATH)/command/mgdrawsplines.cpp \
                    $(SRC_PATH)/command/mgdrawtriang.cpp
