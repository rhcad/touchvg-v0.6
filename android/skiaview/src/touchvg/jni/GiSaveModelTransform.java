...
public class GiSaveModelTransform {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        skiaviewJNI.delete_GiSaveModelTransform(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public GiSaveModelTransform(GiTransform xform, Matrix2d mat) {
    this(skiaviewJNI.new_GiSaveModelTransform(GiTransform.getCPtr(xform), xform, Matrix2d.getCPtr(mat), mat), true);
  }
