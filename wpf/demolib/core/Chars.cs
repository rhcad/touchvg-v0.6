...
public class Chars : IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          democmdsPINVOKE.delete_Chars(swigCPtr);
        }
  ...
  public char get(int index) {
    char ret = democmdsPINVOKE.Chars_get(swigCPtr, index);
    return ret;
  }

  public void set(int index, char value) {
    democmdsPINVOKE.Chars_set__SWIG_0(swigCPtr, index, value);
  }

  public void set(int index, char v1, char v2) {
    democmdsPINVOKE.Chars_set__SWIG_1(swigCPtr, index, v1, v2);
  }
