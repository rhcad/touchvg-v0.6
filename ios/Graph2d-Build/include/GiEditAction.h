...
@property (nonatomic)   const void* shape;      //!< 选中的图形, MgShape*
...
@property (nonatomic,assign)    NSMutableDictionary* extra; //!< 更多的按钮
@property (nonatomic,assign)    UIButton*   button;         //!< 将要添加的按钮

- (int)getActionIndex:(int)action;              //!< 返回菜单按钮的序号
- (int)getActionCount;                          //!< 返回菜单按钮个数
...
- (UIButton*)contextButtonWillAdded:(GiActionParams*)params; //!< 调整按钮外观
- (void)doExtraAction:(UIView *)btn;        //!< 点击额外的上下文按钮
